...
public class InscriptionPanel extends JPanel {
    ...
    public InscriptionPanel(){
        ...
        fieldNom.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldNom.setForeground(new java.awt.Color(102, 102, 102));
        fieldNom.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        fieldPrenom.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldPrenom.setForeground(new java.awt.Color(102, 102, 102));
        fieldPrenom.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        fieldMDP.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldMDP.setForeground(new java.awt.Color(102, 102, 102));
        fieldMDP.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        fieldPseudo.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldPseudo.setForeground(new java.awt.Color(102, 102, 102));
        fieldPseudo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        fieldMDP.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldMDP.setForeground(new java.awt.Color(102, 102, 102));
        fieldMDP.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        fieldMDPVerification.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        fieldMDPVerification.setForeground(new java.awt.Color(102, 102, 102));
        fieldMDPVerification.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(12, 91, 160)));

        labelNom.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        labelNom.setForeground(new java.awt.Color(153, 153, 153));

        labelPrenom.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        labelPrenom.setForeground(new java.awt.Color(153, 153, 153));

        labelPseudo.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        labelPseudo.setForeground(new java.awt.Color(153, 153, 153));

        labelMDP.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        labelMDP.setForeground(new java.awt.Color(153, 153, 153));

        labelMDPVerification.setFont(new java.awt.Font("Segoe UI", 0, 10)); // NOI18N
        labelMDPVerification.setForeground(new java.awt.Color(153, 153, 153));
