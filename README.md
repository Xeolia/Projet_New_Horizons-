...
- la liste des discussions en cours <img src="/Photo/ListeConversation.png"  width="800" alt="e1inscription">
- la création d'une nouvelle conversation <img src="/Photo/CreationConversation.PNG"  width="800" alt="e1CreationConv">
- le chat dans une conversation donnée <img src="/Photo/ConversationSimple.png"  width="800" alt="e1CreationConv">
